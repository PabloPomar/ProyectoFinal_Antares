...
namespace ProyectoFinal.Antares.Domain.Servicios
{
        ...
        where T : BaseModel
    {
        ...
        {
            _logger.LogInformation(LogStrings.ReferenceService.Save, typeof(T).Name, entity);
        ...
        {
            _logger.LogInformation(LogStrings.ReferenceService.Delete, typeof(T).Name, id);
        ...
        {
            _logger.LogInformation(LogStrings.ReferenceService.One, typeof(T).Name, id); 
            return await _repository.FindAsync(id) ?? throw new InvalidOperationException();
        }
        
        public async Task<IEnumerable<T>> GetAsync(Expression<Func<T, bool>> filter)
        {
            _logger.LogInformation(LogStrings.ReferenceService.Find, typeof(T).Name, filter); 
        ...
        {
            _logger.LogInformation(LogStrings.ReferenceService.AddRange, typeof(T).Name);
